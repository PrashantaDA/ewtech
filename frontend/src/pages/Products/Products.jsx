...
import { useGetProductDetailsQuery, useCreateReviewMutation } from "../../reduxtoolkit/api/productApiSlice";
				...
				<>
					<div className="flex flex-wrap relative items-between mt-[2rem] ml-[10rem]">
						...
						<div className="flex flex-col justify-between">
							...
							<p className="my-4 xl:w-[35rem] lg:w-[35] md:w-[30rem] text-[#B0B0B0]">{product.description}</p>
